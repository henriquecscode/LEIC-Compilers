...
import pt.up.fe.comp.SymbolTableImp;
...
public class JmmSemanticsResult implements ReportsProvider {
    ...
    private final SymbolTableImp symbolTable;
    private final List<Report> reports;
    private final Map<String, String> config;

    public JmmSemanticsResult(JmmNode rootNode, SymbolTableImp symbolTable, List<Report> reports,
                              Map<String, String> config) {
        this.rootNode = rootNode;
        this.symbolTable = symbolTable;
        this.reports = symbolTable.getReports();
        this.config = config;
    }

    public JmmSemanticsResult(JmmParserResult parserResult, SymbolTableImp symbolTable, List<Report> reports) {
